...
class User {
  ...
  toHtml() {
    return this.todoLists.map(todo => todo.toHtml());
  }
...
// this.users = [
//   {username: 'A', name: 'A', password: 123, todoLists: [{}, {}]},
//   {username: 'B', name: 'B', password: 321, todoLists: []},
//   {username: 'C', name: 'C', password: 132, todoLists: []}
// ];
